<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="类别编号" prop="leibiebianhao">
					<el-input v-model="ruleForm.leibiebianhao" placeholder="类别编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.leibiebianhao" label="类别编号" prop="leibiebianhao">
					<el-input v-model="ruleForm.leibiebianhao" placeholder="类别编号" readonly></el-input>
				</el-form-item>
